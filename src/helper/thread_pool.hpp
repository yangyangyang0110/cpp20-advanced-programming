...
inline auto make_task(Func &&func, Args &&...args) -> std::packaged_task<RetType(void)>
{
#else
...
public:
    ...
    template <typename Function, typename RetType = typename std::result_of<Function(void)>::type>
